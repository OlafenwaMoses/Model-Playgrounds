...
class actionThreadResNet(threading.Thread):
    ...
    def run(self):
        ...
        import ResNet
        result = ResNet.predict(self.path, self.model_path, self.index_file_path, self.main_ui) # This calls the ResNet Prediction Class
...
class Mainapp(wx.Frame):
    ...
    def processPicture(self, path, model_path, index_file_path):
        ...
        action = actionThreadResNet(path, model_path, index_file_path, self)
        action.start()
